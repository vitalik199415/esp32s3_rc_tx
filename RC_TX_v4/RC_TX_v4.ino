...
void drawModelIcon(uint8_t x, uint8_t y, ModelType t) {
    switch (t) {
        ...
        case MODEL_HELI:     drawModelBitmap(x, y, epd_bitmap_drone); break;
...
void setup() {
    ...
    // // pinMode(PIN_LED_GREEN, OUTPUT); // LED removed  // → PCF8575
    // pinMode(PIN_BUZZER,    OUTPUT);  // → PCF8575
    // // digitalWrite(PIN_LED_GREEN, LOW); // LED removed  // → PCF8575
    // digitalWrite(PIN_BUZZER,    LOW);  // → PCF8575
    ...
    // pinMode(PIN_SW3A_A, INPUT_PULLUP); pinMode(PIN_SW3A_B, INPUT_PULLUP);  // → PCF8575
    // pinMode(PIN_SW3B_A, INPUT_PULLUP); pinMode(PIN_SW3B_B, INPUT);  // → PCF8575
    // pinMode(PIN_SW_ARM, INPUT_PULLUP); pinMode(PIN_SW_RTH, INPUT_PULLUP);  // → PCF8575
    // pinMode(PIN_BTN_UP,    INPUT_PULLUP); pinMode(PIN_BTN_DOWN,  INPUT_PULLUP);  // → PCF8575
    // pinMode(PIN_BTN_BACK,  INPUT_PULLUP); pinMode(PIN_BTN_RIGHT, INPUT_PULLUP);  // → PCF8575
    // pinMode(PIN_BTN_OK,    INPUT_PULLUP);  // → PCF8575
